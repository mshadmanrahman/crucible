...
- **Track Record requires file access.** When Track Record is in the bench, the subagent prompt must include the reading list (MEMORY.md, relevant shards, recent handoffs). See `personas.md` for specifics.
...
- `personas.md`, all 17 persona rubrics with model tier and output format
- `benches.md`, problem-type to bench mapping plus all 5 modes
